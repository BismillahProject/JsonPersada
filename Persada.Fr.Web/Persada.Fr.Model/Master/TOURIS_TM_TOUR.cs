namespace Persada.Fr.Model.Master
{
    ...
    public partial class TOURIS_TM_TOUR
    {
       public TOURIS_TM_TOUR()
        {
            TOURIS_TM_TOUR_PHOTO = new HashSet<TOURIS_TM_TOUR_PHOTO>();
        }
        ...
        public virtual ICollection<TOURIS_TM_TOUR_PHOTO> TOURIS_TM_TOUR_PHOTO { get; set; }
